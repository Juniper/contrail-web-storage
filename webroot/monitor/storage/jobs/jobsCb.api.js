...
jobsCb.jobsProcess = function() {
  parseJobsReq.jobsApi.jobs.process('getStorageClusterStatus', maxActiveJobs, function(job, done) {
  ...
  parseJobsReq.jobsApi.jobs.process('getStorageOSDsSummary', maxActiveJobs, function(job, done) {
  /* Publish the data on pubChannel And Save the data key as 
     saveChannelKey
   */
    var jobStartTime = parseJobsReq.commonUtils.getCurrentTimestamp();
